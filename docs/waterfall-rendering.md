...
- `WaterfallCursor` snaps selection to source-bin centers, clamps movement to the mapped span, and preserves the nearest frequency across context changes. Cursor controls only update local display state in this slice.
