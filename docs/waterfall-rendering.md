...
- Renderer-side overlays draw a white tuned-frequency column and optional orange passband-edge columns on a raster copy. History/model values remain unchanged, markers outside the mapped span are omitted, and passband order is validated.
